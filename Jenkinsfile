pipeline {
    ...
    stages {
        ...
        stage('Build Docker Image') {
            ...
            steps {
                script {
                    app = docker.build("jnms1/train-schedule")
                    app.inside {
        ...
        stage('DeployToProduction') {
            ...
            script {
                ...
                sh "sshpass -p '$USERPASS' -v ssh -o StrictHostKeyChecking=no $USERNAME@${env.prod_ip} \"docker run --restart always --name train-schedule -p 8080:8080 -d jnms1/train-schedule:${env.BUILD_NUMBER}\""
             }
         }
     }
  }
